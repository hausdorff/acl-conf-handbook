...
% Morning Tutorials
\newcommand{\TutLocA}{\DCW} % T1
\newcommand{\TutLocB}{\EBR} % T2
\newcommand{\TutLocC}{\DRE} % T3
\newcommand{\TutLocD}{\JJ}  % T4

\newcommand{\TutLocE}{\EBR} % T5
\newcommand{\TutLocF}{\DRE} % T6
\newcommand{\TutLocG}{\DCW} % T7
\newcommand{\TutLocH}{\JJ}  % T8
